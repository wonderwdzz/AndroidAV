...
Java_com_wd_rtmpbilibili_ScreenLive_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
JNIEXPORT jboolean JNICALL
Java_com_wd_rtmpbilibili_ScreenLive_sendData(JNIEnv *env, jobject thiz, jbyteArray data_, jint len,
                                             jlong tms,jint type) {
    int ret;
